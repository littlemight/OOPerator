...
"}"));
        ...
        squareBtn = new QPushButton(centralwidget);
        squareBtn->setObjectName(QString::fromUtf8("squareBtn"));
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(squareBtn->sizePolicy().hasHeightForWidth());
        squareBtn->setSizePolicy(sizePolicy);
        QFont font;
        font.setPointSize(12);
        font.setBold(false);
        font.setWeight(50);
        squareBtn->setFont(font);
        squareBtn->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"	background-color: #f8c414;\n"
"	color: #000000;\n"
"	padding: 5px;\n"
"}"));

        gridLayout->addWidget(squareBtn, 7, 4, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(signBtn, 9, 0, 1, 1);
...
"}"));
    ...
    void retranslateUi(QMainWindow *Calculator)
    {
        ...
        squareBtn->setText(QCoreApplication::translate("Calculator", "pow", nullptr));
        ...
        signBtn->setText(QCoreApplication::translate("Calculator", "+/-", nullptr));
