\hypertarget{struct_catch_1_1_i_exception_translator}{}\doxysection{Catch\+::I\+Exception\+Translator Struct Reference}
...
\begin{center}
\leavevmode
\includegraphics[width=251pt]{struct_catch_1_1_i_exception_translator__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=217pt]{struct_catch_1_1_i_exception_translator__coll__graph}
\end{center}
\end{figure}
